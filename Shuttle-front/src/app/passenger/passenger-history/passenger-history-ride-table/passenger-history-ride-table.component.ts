...
@Component({
  selector: 'app-passenger-history-ride-table',
  templateUrl: './passenger-history-ride-table.component.html',
  styleUrls: ['./passenger-history-ride-table.component.css']
})
export class PassengerHistoryRideTableComponent implements OnInit {
