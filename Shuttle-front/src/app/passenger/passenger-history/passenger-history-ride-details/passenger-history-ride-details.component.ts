...
@Component({
  ...
  templateUrl: './passenger-history-ride-details.component.html',
  styleUrls: ['./passenger-history-ride-details.component.css']
})
export class PassengerHistoryRideDetailsComponent  implements OnChanges {
